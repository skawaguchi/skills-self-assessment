...
| :---- | --------: | -----: | ------------- |
| **Build** |
| Mobile | 1 | 1 | Direct experience with React Native, but the bulk was set up before I joined. |
...
| Foundation | 2 | 3 | I've set up a few side-projects, but am just learning systems design and polishing my skills. |
| Servers | 2 | 3 | I've never set up production server apps myself. However, I've done significant code reviews and integrated code. Long experience adjusting server-side code from ASP Classic, ASP.NET, Java, JSP, JSF, Ruby on Rails. |
| *Sub-Total* | | **19** |
| **Executing** |
...
| *Sub-Total* | | **18** |
| **Strengthening** |
| Mentorship | 3 | 6 | I've mentored developers and managers at many levels, including executives. Most of my work has been with engineers. Many of the younger developers I've mentored have gone on to become tech leads or architects. | 
